...
export class SiaeStorage implements ISiaeStorage {
  ...
  async getSiaeTicketedEventsByCompany(companyId: string) {
    return await db.select({
      ...
      approvedBy: siaeTicketedEvents.approvedBy,
      approvedAt: siaeTicketedEvents.approvedAt,
      rejectedReason: siaeTicketedEvents.rejectedReason,
  ...
  async getSiaeTicketedEvent(id: string): Promise<any> {
